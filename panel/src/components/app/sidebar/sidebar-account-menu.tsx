...
export function SidebarAccountMenu({ onOpenSettings }: SidebarAccountMenuProps) {
  ...
  return (
    <div ref={accountMenuRef} className="relative mt-auto">
      {isOpen ? (
        <div className="absolute right-0 bottom-full left-0 z-20 mb-2 overflow-hidden rounded-2xl border border-border/80 bg-popover/98 p-1.5 text-popover-foreground shadow-2xl backdrop-blur">
